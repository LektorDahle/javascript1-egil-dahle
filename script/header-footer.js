...
export class Header extends Body {
    ...
    createNav() {
        ...
        this.addListItemWithImage(ul, "Cart", "cart", String(window.location.pathname) + "/img/icons/cart-lightmode.svg", String(window.location.pathname)+ "../img/icons/cart-darkmode.svg");
    }
    /**
