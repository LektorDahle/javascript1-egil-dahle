...
export class Header extends Body {
    ...
    createNav() {
        ...
        this.addListItemWithImage(ul, "Cart", "cart", `/${window.location.pathname.split("/")[1]}/img/icons/cart-lightmode.svg`, `/${window.location.pathname.split("/")[1]}../img/icons/cart-darkmode.svg`);
    }
    /**
